...
Learn how to make your app discoverable on Mezon through various surfaces and best practices to drive more users to discover it.

## Discovery Surfaces

Once you've [enabled discovery for your app](#DOCS_DISCOVERY_ENABLING_DISCOVERY), users can find your app in Mezon through the App Directory and the App Launcher.
...
![Your Mezon App Profile](discovery-app-directory-product-page.png)

### App Launcher

The App Launcher lets users discover new apps through collections and search from the app shapes icon <Icon icon="AppsIcon" /> throughout Mezon.
...
![App Launcher in Mezon](discovery-app-launcher.png)
...
- **Partner Apps**: Some apps may be developed in collaboration with Mezon, marked with a "Partner" tag
...
Apps can be featured in the App Directory or App Launcher as part of a curated collection or promotion. Mezon's editorial team will reach out to you if we are interested in featuring your app.

---

## Social Discovery

Once your app is discoverable, there are several ways users may find it through social interactions in Mezon. Users may discover your app through other users using it. When your app is used in a server, it may be visible to other users in the server, allowing users to learn more about it and install it themselves from your app's profile.

### Sharing Links

Create shareable links to your app's profile page, store page, or specific items. Share these links in Mezon, emails, or on your website.

![A shared embed link in Mezon for the Sandscape app](discovery-sharing-links.png)
