...
Guilds in Mezon represent an isolated collection of users and channels, and are often referred to as "servers" in the UI.
...
| preferred_locale               | string                                                                              | the preferred [locale](#DOCS_REFERENCE/locales) of a Community guild; used in server discovery and notices from Mezon, and sent in interactions; defaults to "en-US"                      |
| public_updates_channel_id      | ?snowflake                                                                          | the id of the channel where admins and moderators of Community guilds receive notices from Mezon                                                                                          |
...
| safety_alerts_channel_id       | ?snowflake                                                                          | the id of the channel where admins and moderators of Community guilds receive safety alerts from Mezon                                                                                    |
...
| MEDIUM    | 2       | must be registered on Mezon for longer than 5 minutes   |
...
```json
{
  ...
  "description": "The official place to report Mezon Bugs!",
  "splash": null,
...
```json
{
  ...
  "name": "Test Server",
  "instant_invite": "https://mezon.com/invite/abcdefg",
  "channels": [
    {
...
| premium_since?                | ?ISO8601 timestamp                                                                   | when the user started [boosting](https://support.mezon.com/hc/en-us/articles/360028038352-Server-Boosting-) the guild                                                                                                              |
...
| communication_disabled_until? | ?ISO8601 timestamp                                                                   | when the user's [timeout](https://support.mezon.com/hc/en-us/articles/4413305239191-Time-Out-FAQ) will expire and the user will be able to communicate in the guild again, null or a time in the past if the user is not timed out |
...
| type                    | string                                                                                               | integration type (twitch, youtube, mezon, or guild_subscription)              |
...
| application?            | [application](#DOCS_RESOURCES_GUILD/integration-application-object) object                           | The bot/OAuth2 application for mezon integrations                             |
...
\* These fields are not provided for mezon bot integrations.
> warn
...
```json
{
  "description": "Mezon Developers is a place to learn about Mezon's API, bots, and SDKs and integrations. This is NOT a general Mezon support server.",
  "welcome_channels": [
    {
      "channel_id": "697138785317814292",
      "description": "Follow for official Mezon API updates",
      "emoji_id": null,
      "emoji_name": "📡"
    },
    {
    ...
    },
    {
      ...
      "description": "Create amazing things with Mezon's API",
      "emoji_id": null,
      "emoji_name": "🔬"
    },
    {
      "channel_id": "613425918748131338",
      "description": "Integrate Mezon into your game",
      "emoji_id": null,
      "emoji_name": "🎮"
    },
    {
...
Represents the [onboarding](https://support.mezon.com/hc/en-us/articles/11074987197975-Community-Onboarding-FAQ) flow for a guild.
...
| public_updates_channel_id     | ?snowflake                                                                          | the id of the channel where admins and moderators of Community guilds receive notices from Mezon                                                                |
| preferred_locale              | ?string                                                                             | the preferred [locale](#DOCS_REFERENCE/locales) of a Community guild used in server discovery and notices from Mezon; defaults to "en-US"                       |
| features                      | array of [guild feature](#DOCS_RESOURCES_GUILD/guild-object-guild-features) strings | enabled guild features                                                                                                                                            |
| description                   | ?string                                                                             | the description for the guild                                                                                                                                     |
...
|---------|----------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------|
| shield  | shield style widget with Mezon icon and guild members online count                                                                                           | [Example](https://mezon.com/api/guilds/81384788765712384/widget.png?style=shield)  |
| banner1 | large image with guild icon, name and online count. "POWERED BY MEZON" as the footer of the widget                                                           | [Example](https://mezon.com/api/guilds/81384788765712384/widget.png?style=banner1) |
| banner2 | smaller widget style with guild icon, name and online count. Split on the right with Mezon logo                                                              | [Example](https://mezon.com/api/guilds/81384788765712384/widget.png?style=banner2) |
| banner3 | large image with guild icon, name and online count. In the footer, Mezon logo on the left and "Chat Now" on the right                                        | [Example](https://mezon.com/api/guilds/81384788765712384/widget.png?style=banner3) |
| banner4 | large Mezon logo at the top of the widget. Guild icon, name and online count in the middle portion of the widget and a "JOIN MY SERVER" button at the bottom | [Example](https://mezon.com/api/guilds/81384788765712384/widget.png?style=banner4) |
