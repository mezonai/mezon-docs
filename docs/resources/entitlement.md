...
Entitlements in Mezon represent that a user or guild has access to a premium offering in your application. 
...
| PREMIUM_SUBSCRIPTION     | 2     | Entitlement for Mezon Nitro subscription                     |
...
Creates a test entitlement to a given SKU for a given guild or user. Mezon will act as though that user or guild has entitlement to your premium offering.
...
After creating a test entitlement, you'll need to reload your Mezon client. After doing so, you'll see that your server or user now has premium access.
...
Deletes a currently-active test entitlement. Mezon will act as though that user or guild _no longer has_ entitlement to your premium offering.
