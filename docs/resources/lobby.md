...
Represents a lobby within Mezon. See [Managing Lobbies](#DOCS_DISCORD_SOCIAL_SDK_DEVELOPMENT_GUIDES_MANAGING_LOBBIES) for more information.
...
> info 
> [Mezon Social SDK](#DOCS_DISCORD_SOCIAL_SDK_OVERVIEW) clients will not be able to join or leave a lobby created using this API, such as [`Client::CreateOrJoinLobby`]. See [Managing Lobbies](#DOCS_DISCORD_SOCIAL_SDK_DEVELOPMENT_GUIDES_MANAGING_LOBBIES) for more information.
...
| Field     | Type                  | Description                                                                                                                                          |
|-----------|-----------------------|------------------------------------------------------------------------------------------------------------------------------------------------------|
| id        | snowflake             | Mezon user id of the user to add to the lobby                                                                                                      |
| metadata? | ?dict<string, string> | optional dictionary of string key/value pairs. The max total length is 1000.                                                                         |
| flags?    | integer               | [lobby member flags](#DOCS_RESOURCES_LOBBY/lobby-member-object-lobby-member-flags) combined as a [bitfield](https://en.wikipedia.org/wiki/Bit_field) |
...
[`Client::CreateOrJoinLobby`]: https://mezon.com/developers/docs/social-sdk/classdiscordpp_1_1Client.html#a8b4e195555ecaa89ccdfc0acd28d3512
[`LobbyHandle`]: https://mezon.com/developers/docs/social-sdk/classdiscordpp_1_1LobbyHandle.html#aa3510c347c4c4758bdf9f19caf2a95f3