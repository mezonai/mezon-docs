...
| verify_key                         | string                                                                                                                                | Hex encoded key for verification in interactions and the GameSDK's [GetTicket](https://github.com/mezon/mezon-docs/blob/legacy-gamesdk/docs/game_sdk/Applications.md#getticket)                                                    |
