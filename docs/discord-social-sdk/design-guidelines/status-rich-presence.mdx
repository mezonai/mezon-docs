...
[Home](#DOCS_INTRO) > [Mezon Social SDK](#DOCS_DISCORD_SOCIAL_SDK_OVERVIEW) > [Design Guidelines](#DOCS_DISCORD_SOCIAL_SDK_DESIGN_GUIDELINES) > Status & Rich Presence
...
Any of the **core statuses** (online, idle, DND, offline) will always be the same between the game and the Mezon client.
...
To ensure player comprehension, keep the **core colors, symbols, and information architecture consistent** across Mezon-powered games — with choice of styling of applied. 
...
The game developer should set rich presence — this will show in both the Mezon and game client. 
