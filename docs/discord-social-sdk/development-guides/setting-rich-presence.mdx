...
Rich Presence allows you to display detailed information about what players are doing in your game. Users can see this information in their Mezon profile and friends list and use it to join their friends' games with Game Invites.

### Prerequisites

Before you begin, make sure you have:
- [Set up the Mezon Social SDK](#DOCS_DISCORD_SOCIAL_SDK_GETTING_STARTED)
- Connected to Mezon with a valid client instance

---

## Understanding Rich Presence

Rich Presence allows you to display detailed information about players' actions in your game. Users can see this information in various places in Mezon, including:
...
When displayed in Mezon, Rich Presence has three main components:
...
You can control how lines 2 and 3 are rendered in Mezon, here's the breakdown:

- Line 1, `Playing "game name"` is powered by the name of your game (or application) on Mezon.
...
The Rich Presence invite image appears when invites are sent for a 3rd party game or app using the Mezon Social SDK. After uploading an invite image for your app, you can see a preview of it to the right (under "IRL Invite Image Example").
...
Up to 300 custom assets can be added to your app for later use when setting Rich Presence for a Mezon user. These assets can be anything that help orient others to what a user is doing inside of your Activity or 3rd party game.
...
You can set the supported platforms for your game in Rich Presence. This will control where the join buttons appear in Mezon.
...
[`ActivityTypes`]: https://mezon.com/developers/docs/social-sdk/namespacediscordpp.html#a6c76a8cbbc9270f025fd6854d5558660