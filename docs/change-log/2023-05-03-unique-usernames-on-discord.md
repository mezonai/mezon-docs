---
title: "Unique usernames on Mezon"
date: "2023-05-03"
---
...
As part of the new username system, standard Mezon users can define a non-unique display name. This value will be a new `global_name` field with a max length of 32 characters. If the user has not set a display name, `global_name` will be null.
