...
Read more in the [Moderating Apps on Mezon Help Center article](https://support.mezon.com/hc/en-us/articles/23957313048343-Moderating-Apps-on-Mezon#h_01HZQQQEADYVN2CM4AX4EZGKHM).

###### Updated Defaults for New Apps

* Newly-created apps now default to having both "User Install" *and* "Guild Install" [installation contexts](#DOCS_RESOURCES_APPLICATION/installation-context) enabled. This can be updated in the **Installation** tab in an [app's settings](https://mezon.com/developers/applications).
* Newly-created apps now default to using the "Mezon Provided Link" [install link](#DOCS_RESOURCES_APPLICATION/install-links). This can be updated in the **Installation** tab in an [app's settings](https://mezon.com/developers/applications).
* If Mezon Provided Link is selected as the install link type, `application.commands` scope is added to both installation contexts.
