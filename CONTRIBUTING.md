...
```markdown
<LinkButton to="https://mezon.com/developers/docs/getting-started" color="brand">click the button!</LinkButton>
```
...
```markdown
<Card title="Card Title" link="https://mezon.com/developers/docs/getting-started">
